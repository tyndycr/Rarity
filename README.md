...
Use *this branch* in conjuction with [this client front-end](https://github.com/Leo32onGIT/forgottenserver-flash-accmaker);\
For complete test environment for [theforgottenserver](https://github.com/otland/forgottenserver).

The included map has everything you need to test changes with your engine.
